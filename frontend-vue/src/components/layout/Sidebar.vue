...
<template>
  <aside
    class="hidden md:flex md:flex-col md:fixed md:inset-y-0 md:left-0 md:z-40 w-16 hover:w-56 lg:w-56 lg:hover:w-56 border-r border-sidebar-border bg-sidebar/90 backdrop-blur-xl transition-all duration-300 ease-out group overflow-hidden"
  >
    ...
    <div class="flex items-center justify-center h-14 px-2 border-b border-sidebar-border relative shrink-0">
      <div class="flex items-center gap-2">
        ...
        <span class="font-semibold text-sidebar-foreground whitespace-nowrap opacity-0 group-hover:opacity-100 lg:opacity-100 transition-opacity duration-200">工单管理</span>
      </div>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-1 relative">
      <button
        ...
        :key="item.path"
        class="flex items-center justify-center group-hover:justify-start lg:justify-start gap-3 w-full px-2 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 relative overflow-hidden group/item"
        :class="
          isActive(item.path)
      ...
      >
        ...
        <span class="whitespace-nowrap opacity-0 group-hover:opacity-100 lg:opacity-100 transition-opacity duration-200">{{ item.name }}</span>
      </button>
    </nav>
    ...
    <div class="p-2 border-t border-sidebar-border relative shrink-0">
      ...
      <div
        class="flex items-center justify-center group-hover:justify-start lg:justify-start gap-3 p-2 rounded-lg hover:bg-sidebar-accent cursor-pointer transition-all duration-200 group/item"
      ...
      >
        ...
        <div class="flex-1 min-w-0 opacity-0 group-hover:opacity-100 lg:opacity-100 transition-opacity duration-200">
