        ...
        <body>
          ...
          <table class="info-table">
            ...
            <tr>
              ...
              <td colspan="3">${record.service_address || record.work_address || '-'}</td>
            </tr>
            <tr>
          ...
          <div class="section-title">工作内容 / 故障描述</div>
          <div style="min-height: 80px; border: 1px solid #ddd; padding: 12px; margin-bottom: 20px;">
            ${record.work_content || record.fault_description || record.construction_content || '无'}
          </div>
