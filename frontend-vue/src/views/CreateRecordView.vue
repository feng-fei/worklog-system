...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (form.value.contact_person) submitData.append('contact_person', form.value.contact_person)
    if (form.value.contact_phone) submitData.append('contact_phone', form.value.contact_phone)
    if (form.value.address) submitData.append('address', form.value.address)
    if (form.value.appointment_date) submitData.append('appointment_date', form.value.appointment_date)
    ...
    if (form.value.fault_phenomenon) submitData.append('fault_phenomenon', form.value.fault_phenomenon)
    if (form.value.fault_judgment) submitData.append('fault_judgment', form.value.fault_judgment)
    ...
    submitData.append('labour_fee', String(form.value.labour_fee || 0))
    submitData.append('material_fee', String(form.value.material_fee || 0))
    submitData.append('travel_fee', String(form.value.travel_fee || 0))
